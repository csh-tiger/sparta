...
class MainPageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dataList.add(MyItem(R.drawable.sample1, "산진 한달된 선풍기 팝니다", "서울 서대문구 창천동", "1000", "13", "25", "이사가서 필요가 없어졌어요 급하게 내놓습니다",	"대현동"))
        dataList.add(MyItem(R.drawable.sample2, "김치냉장고", "인천 계양구 귤현동", "20000", "8", "28", "이사로인해 내놔요",	"안마담"))
        dataList.add(MyItem(R.drawable.sample3, "샤넬 카드지갑", "수성구 범어동", "10000", "23", "5", "고퀄지갑이구요\n사용감이 있어서 싸게 내어둡니다",	"코코유"))
        ...
        adapter.itemClick = object : MyAdapter.ItemClick {
            override fun onClick(view: View, position: Int) {
                ...
                intent.putExtra("dataFromMain", dataList[position])
        ...
        val onBackPressedCallback = object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                var builder = AlertDialog.Builder(this@MainPageActivity)
                builder.setTitle("종료하시겠습니까?")
                builder.setMessage("'예'를 누르면 종료됩니다.")
